...
Animation::Animation(const std::filesystem::path &animationPath, SkinnedMeshData *meshData)
{
    LoadAnimation(animationPath, meshData, 0);
}

void Animation::LoadAnimation(const std::filesystem::path &animationPath, SkinnedMeshData *meshData, int index)
{
...
void Animation::ReadMissingBones(const aiAnimation *animation, SkinnedMeshData meshData)
{
	int size = animation->mNumChannels;

	auto &boneInfoMap = meshData.BoneInfoMap;
