...
namespace Layers
{
static constexpr ObjectLayer UNUSED1 =
    0; // 4 unused values so that broadphase layers values don't match with object layer values (for testing purposes)
  ...
  public:
    virtual bool ShouldCollide(ObjectLayer inObject1, ObjectLayer inObject2) const override
    {
        switch (inObject1)
        {
            ...
            case Layers::UNUSED2:
            case Layers::UNUSED3:
            case Layers::UNUSED4: return false;
            ...
            case Layers::DEBRIS: return inObject2 == Layers::NON_MOVING;
  ...
  public:
    virtual bool ShouldCollide(ObjectLayer inLayer1, BroadPhaseLayer inLayer2) const override
    {
        switch (inLayer1)
        {
            ...
            case Layers::DEBRIS: return inLayer2 == BroadPhaseLayers::NON_MOVING;
            case Layers::SENSOR: return inLayer2 == BroadPhaseLayers::MOVING;
            case Layers::UNUSED3: return false;
            default: assert(false); return false;
        }
    }
};
