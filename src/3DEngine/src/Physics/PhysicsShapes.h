...
class Box : public PhysicShape
{
  ...
  public:
    Box() : Size(glm::vec3(1.0f)) { m_Type = RigidBodyShapes::BOX; };
    Box(glm::vec3 size) : Size(size) { m_Type = RigidBodyShapes::BOX; };
    Box(float x, float y, float z) : Size(glm::vec3(x, y, z)) { m_Type = RigidBodyShapes::BOX; };
...
class Sphere : public PhysicShape
{
  ...
  public:
    Sphere(float radius) : Radius(radius) { m_Type = RigidBodyShapes::SPHERE; };
...
class Capsule : public PhysicShape
{
  ...
  public:
    Capsule() = default;
    Capsule(float radius, float height) : Radius(radius), Height(height) { m_Type = RigidBodyShapes::CAPSULE; }
...
class Cylinder : public PhysicShape
{
  ...
  public:
    Cylinder(float radius, float height) : Radius(radius), Height(height) { m_Type = RigidBodyShapes::CYLINDER; }
